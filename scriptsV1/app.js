...
const clientsHandlers = require("./clients-handlers.js");
const usersHandlers = require("./users-handlers.js");
const authenticationHandlers = require("./authentication-handlers.js");
const globalHandlers = require("./globalHandlers.js");
const jobsHandlers = require("./jobs-handlers.js");
const messagingHandlers = require("./messaging-handlers.js");
...
function connectMessage(message) {
  ...
  if (client === null) {
    messagingHandlers.messagingInsertNew(message, () => {});
    return;
  }
